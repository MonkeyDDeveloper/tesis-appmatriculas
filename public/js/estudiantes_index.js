(() => {
    ...
    function deleteVars() {
        let nodesToDelete = [document.getElementById('enrollment_features'), document.getElementById('subjectsLimit'), document.getElementById('max_hours')]
    ...
    function giveMessageAboutHours() {
        ...
        if (current_hours > max_hours) {
            ...
            else submit_button.style.display = 'none' 
        ...
        return new Promise(async (res, rej) => {
            try {
                ...
                let {
                    status,
                    message
                } = await fetch('/student/newEnroll', options).then(res => res.json())
    ...
    function successEnrollment() {
        window.location.href = '/student/mis_matriculas'
    }
